...
export const ui = {
  uk: {
    ...
    hoursSuffix: "год",
    boardTitle: "Робота без шуму",
    boardDesc:
      "Тільки те, що справді робиться зараз або конкретно стоїть наступним.",
  ...
  en: {
    ...
    hoursSuffix: "h",
    boardTitle: "Work without noise",
    boardDesc:
      "Only work that is actually in progress or concretely next.",
