...
3. Передати чинний погоджений командний пароль лише через env і зібрати.
   Оновлення даних не ротуватиме пароль; змінювати його можна тільки після
   окремої прямої команди Andriy:
